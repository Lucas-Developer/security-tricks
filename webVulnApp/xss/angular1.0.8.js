...
function lex(text, csp){
  ...
  function readIdent() {
    ...
    if (OPERATORS.hasOwnProperty(ident)) {
      ...
      // token.fn = function with getter() inside, which is getterFn
...
function getterFn(path, csp) {
  ...
  if (csp) {
    ...
    code += 'return s;';
    // build a function that takes as parameter the scope and locals
    // `code` : String - contains the dynamically generated code
    // getterFN - Create a function that will get a property
    debugger;
